...
async def test_uart(dut):
    ...
    dut.cekirdek_wb_yaz_etkin_i.value = 1
    dut.cekirdek_wb_sec_i.value = 0
    ...
    dut.cekirdek_wb_yaz_etkin_i.value = 0
    dut.cekirdek_wb_sec_i.value = 0
    ...
    dut.uart_wb_oku_veri_hazir_i.value = 1
    dut.uart_wb_mesgul_i.value = 0
